...
/**
 * create_xarray of chars and initializes it with the character 'x'. Adds a terminating null byte.
...
/**
 * iterate_zeroes - Iterates through a string of numbers containing leading zeroes untill it hits a non-zero number.
